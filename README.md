...
2. Run the batch file
  ...
  3. Go to the directory where your Main.class and DocuSign6.bat file is.
  4. Write the batch file name and the URL (the file that you want to donwload to measure the speed)
